...
public class ProductTestCase extends EntityTestCriteria {
    ...
    private Product createProduct(Boolean isSave) throws Exception {
        ...
        product.setProductName("vivBpSz4qiRMdU3O0QY66GfD7TcqxF33UWn55tgMhb98b8LuMN");
    ...
    public void test2Update() {
        try {
            ...
            product.setProductName("2jtpiUBqhcWWJymsMcDDH2ombzQidjO2YSyCCXhSZlx5ch7WTQ");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "productName", ""));
