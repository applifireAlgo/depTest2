...
public class QuestionTestCase extends EntityTestCriteria {
    ...
    private Question createQuestion(Boolean isSave) throws Exception {
        ...
        question.setQuestion("Q2VJQ4MD6yuXaKBNnrXXlsBT96DjiwgbHhL99Frb3mUBp6wDVZ");
        question.setQuestionIcon("nhxjREVxVum4mLgPRfhVnHzmj13URmkcgvlGgVI9HuOUDqVydh");
        question.setQuestionDetails("Qh8oPTpz7a");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestion("m6psV4IiVCzi2j6P3VhmVBxIZWABXb9BK2dDlCatKTNdUitXnz");
            question.setQuestionIcon("SnoK0L1iU3TV16hhd1Ulmo6xVuhqU0isf4cG3nsZGeI4dlMIUY");
            question.setQuestionDetails("OFm8llItTE");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "question", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 5, "questionDetails", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 6, "questionIcon", "1zvgHf3CkYDwQdS1LnTjBizTHG75MhHMQMKsO7BgUmWq7Iu6EOPjYx9z49TT9n7AB"));
