 ...
 */
Ext.define('Startone.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Startone.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Startone.view.fw.component.DateTimePicker(o);
    },
