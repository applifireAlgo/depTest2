Ext.define('Startone.view.fw.frameworkController.RegistrationGridViewController', {
     extend: 'Startone.view.fw.frameworkController.FrameworkViewController',
     ...
     onConsoleClick: function() {
          var window = Ext.create('Startone.view.console.ConsoleWindow');
