Ext.define('Startone.view.desktop.design.menubar.main.MainPanelController', {
    ...
    onMyProfileClick : function()
    {
         ...
         this.pushViewInMainTab( "Startone.view.usermanagement.enduser.UserProfile","My Profile","menuAction","Startone.view.usermanagement.enduser.UserProfile");
    },
    
    onChangePwdClick:function()
    {
      
         this.pushViewInMainTab( "Startone.view.usermanagement.enduser.ChangePwd","Change Password","menuAction","Startone.view.usermanagement.enduser.ChangePwd");
    },
     onCloudClick : function()
    {
        
        this.pushViewInMainTab("Startone.view.clouddrive.CloudDrive","Cloud Drive","menuAction","Startone.view.clouddrive.CloudDrive");
    },
    ...
    onLogoutClick : function(logoutBtn)
    {
     ...
     onSearchClick : function(searchBtn){
         ...
         var searchView = this.pushViewInMainTab("Startone.view.searchengine.search.SearchEngineMainPanel","Search Result","isSearchCmp","true");
