Ext.define('Startone.view.desktop.design.menubar.main.MainPanel', {
    extend : 'Ext.panel.Panel',
    xtype : 'mainPanel',
    requires : ['Startone.view.desktop.design.menubar.main.MainPanelController','Startone.view.desktop.design.menubar.menu.AppMenuBar'],
    userinfo:{},
    id:'mainPanel',
