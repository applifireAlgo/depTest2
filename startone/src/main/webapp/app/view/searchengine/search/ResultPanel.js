Ext
		.define(
				'Startone.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Startone.view.searchengine.search.SearchEngineMainPanelController','Startone.view.searchengine.search.PanelHeaderField' ,'Startone.view.searchengine.search.ReportGridView','Startone.view.searchengine.search.ReportChartView','Startone.view.searchengine.search.documentView','Startone.view.searchengine.search.DouMeanView','Startone.view.googlemaps.map.MapPanel'],
