Ext.define('Startone.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'solrsearchmainpanel',
	

	requires : ['Startone.view.searchengine.search.NorthPanel', 'Startone.view.searchengine.search.SearchResult','Startone.view.searchengine.search.SearchEngineMainPanelController'],
