 ...
 * 
 */
Ext.define('Startone.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Startone.view.securityconfig.SecurityConfigController',
			'Startone.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
