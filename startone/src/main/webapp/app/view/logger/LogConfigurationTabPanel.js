...
Ext
		.define(
				'Startone.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Startone.view.logger.tabs.details.DetailsTab',
							'Startone.view.logger.tabs.fileconnector.FileConnectorTab',
							'Startone.view.logger.tabs.dbconnector.DBConnectorTab',
							'Startone.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Startone.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Startone.view.logger.LogConfigurationTabPanelController',
