 ...
 * 
 */
Ext.define('Startone.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Startone.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
