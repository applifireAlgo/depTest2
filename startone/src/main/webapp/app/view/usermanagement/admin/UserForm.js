Ext.define('Startone.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Startone.view.usermanagement.admin.AddUserDetailsViewModel', 'Startone.model.AddUserDataModel' ],
