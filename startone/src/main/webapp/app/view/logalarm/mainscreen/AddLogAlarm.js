 ...
 * 
 */
Ext.define('Startone.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Startone.view.logalarm.mainscreen.AddLogAlarmController',
			'Startone.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Startone.view.logalarm.mainscreen.AppAlarmPanel',
