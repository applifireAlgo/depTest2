 ...
 * 
 */
Ext.define('Startone.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Startone.view.logalarm.LogAlarmMainViewController',
			'Startone.view.logalarm.tree.LogAlarmTreePanel',
			'Startone.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
