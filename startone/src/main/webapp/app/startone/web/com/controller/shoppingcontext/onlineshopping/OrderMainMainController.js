Ext.define('Startone.startone.web.com.controller.shoppingcontext.onlineshopping.OrderMainMainController', {
     extend: 'Startone.view.fw.frameworkController.AggregateViewController',
     ...
     onFilterClick: function(but, evt) {
          ...
          Ext.Ajax.request({
               ...
               failure: function(response, opts) {
                    ...
                    var compRef = currentView.down('#OrderMainTree');
