...
@Repository
@SourceCodeAuthorClass(createdBy = "deepali.arvind@algorhythm.co.in", updatedBy = "deepali.arvind@algorhythm.co.in", versionNumber = "2", comments = "Repository for Currency Master table Entity", complexity = Complexity.LOW)
public class CurrencyRepositoryImpl extends SearchInterfaceImpl implements CurrencyRepository<Currency> {
    ...
    public List<Currency> findAll() throws Exception {
        ...
        java.util.List<com.app.shared.organization.locationmanagement.Currency> query = emanager.createQuery("select u from Currency u where u.systemInfo.activeStatus=1").getResultList();
        Log.out.println("nullLM324100200", runtimeLogInfoHelper.getRequestHeaderBean(), "CurrencyRepositoryImpl", "findAll", "Total Records Fetched = " + query.size());
        return query;
    }
    ...
    public Currency save(Currency entity) throws Exception {
        ...
        Log.out.println("nullLM322100200", runtimeLogInfoHelper.getRequestHeaderBean(), "CurrencyRepositoryImpl", "save", entity);
        return entity;
    }
    ...
    public List<Currency> save(List<Currency> entity) throws Exception {
        ...
        for (int i = 0; i < entity.size(); i++) {
            com.app.shared.organization.locationmanagement.Currency obj = entity.get(i);
            emanager.persist(obj);
        }
        Log.out.println("nullLM322100200", runtimeLogInfoHelper.getRequestHeaderBean(), "CurrencyRepositoryImpl", "saveAll", "Total Records saved = " + entity.size());
        return entity;
    }
    ...
    public void delete(String id) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        com.app.shared.organization.locationmanagement.Currency s = emanager.find(com.app.shared.organization.locationmanagement.Currency.class, id);
        emanager.remove(s);
        Log.out.println("nullLM328100200", runtimeLogInfoHelper.getRequestHeaderBean(), "CurrencyRepositoryImpl", "delete", "Record Deleted");
    }
    ...
    public void update(Currency entity) throws Exception {
        ...
        Log.out.println("nullLM321100200", runtimeLogInfoHelper.getRequestHeaderBean(), "CurrencyRepositoryImpl", "update", entity);
    }
    ...
    public void update(List<Currency> entity) throws Exception {
        ...
        Log.out.println("nullLM321100200", runtimeLogInfoHelper.getRequestHeaderBean(), "CurrencyRepositoryImpl", "updateAll", "Total Records updated = " + entity.size());
    }
    ...
    public List<Object> search(String finderName, Map<String, Object> fields, Map<String, String> fieldMetaData) throws Exception {
        ...
        Log.out.println("nullLM324100200", runtimeLogInfoHelper.getRequestHeaderBean(), "CurrencyRepositoryImpl", "search", "Total Records Fetched = " + list.size());
        return list;
    }
    ...
    public List<Currency> findByCountryId(String countryId) throws Exception {
        ...
        java.util.List<com.app.shared.organization.locationmanagement.Currency> listOfCurrency = query.getResultList();
        Log.out.println("nullLM324100200", runtimeLogInfoHelper.getRequestHeaderBean(), "CurrencyRepositoryImpl", "findByCountryId", "Total Records Fetched = " + listOfCurrency.size());
    ...
    public Currency findById(String currencyId) throws Exception {
        ...
        com.app.shared.organization.locationmanagement.Currency listOfCurrency = (com.app.shared.organization.locationmanagement.Currency) query.getSingleResult();
        Log.out.println("nullLM324100200", runtimeLogInfoHelper.getRequestHeaderBean(), "CurrencyRepositoryImpl", "findById", "Total Records Fetched = " + listOfCurrency);
        return listOfCurrency;
    }
}
