...
@Repository
@SourceCodeAuthorClass(createdBy = "deepali.arvind@algorhythm.co.in", updatedBy = "deepali.arvind@algorhythm.co.in", versionNumber = "2", comments = "Repository for Item Master table Entity", complexity = Complexity.LOW)
public class ItemRepositoryImpl extends SearchInterfaceImpl implements ItemRepository<Item> {
    ...
    public List<Item> findAll() throws Exception {
        ...
        Log.out.println("nullOS324100200", runtimeLogInfoHelper.getRequestHeaderBean(), "ItemRepositoryImpl", "findAll", "Total Records Fetched = " + query.size());
        return query;
    }
    ...
    public Item save(Item entity) throws Exception {
        ...
        Log.out.println("nullOS322100200", runtimeLogInfoHelper.getRequestHeaderBean(), "ItemRepositoryImpl", "save", entity);
        return entity;
    }
    ...
    public List<Item> save(List<Item> entity) throws Exception {
        ...
        Log.out.println("nullOS322100200", runtimeLogInfoHelper.getRequestHeaderBean(), "ItemRepositoryImpl", "saveAll", "Total Records saved = " + entity.size());
        return entity;
    }
    ...
    public void delete(String id) throws Exception {
        ...
        emanager.remove(s);
        Log.out.println("nullOS328100200", runtimeLogInfoHelper.getRequestHeaderBean(), "ItemRepositoryImpl", "delete", "Record Deleted");
    }
    ...
    public void update(Item entity) throws Exception {
        ...
        Log.out.println("nullOS321100200", runtimeLogInfoHelper.getRequestHeaderBean(), "ItemRepositoryImpl", "update", entity);
    }
    ...
    public void update(List<Item> entity) throws Exception {
        ...
        Log.out.println("nullOS321100200", runtimeLogInfoHelper.getRequestHeaderBean(), "ItemRepositoryImpl", "updateAll", "Total Records updated = " + entity.size());
    }
    ...
    public List<Object> search(String finderName, Map<String, Object> fields, Map<String, String> fieldMetaData) throws Exception {
        ...
        Log.out.println("nullOS324100200", runtimeLogInfoHelper.getRequestHeaderBean(), "ItemRepositoryImpl", "search", "Total Records Fetched = " + list.size());
        return list;
    }
    ...
    public List<Item> findByProductId(String productId) throws Exception {
        ...
        Log.out.println("nullOS324100200", runtimeLogInfoHelper.getRequestHeaderBean(), "ItemRepositoryImpl", "findByProductId", "Total Records Fetched = " + listOfItem.size());
        return listOfItem;
    }
    ...
    public List<Item> findByCategoryId(String categoryId) throws Exception {
        ...
        java.util.List<com.app.shared.shoppingcontext.onlineshopping.Item> listOfItem = query.getResultList();
        Log.out.println("nullOS324100200", runtimeLogInfoHelper.getRequestHeaderBean(), "ItemRepositoryImpl", "findByCategoryId", "Total Records Fetched = " + listOfItem.size());
        return listOfItem;
    }

    @Transactional
    public List<Item> findByBrandId(String brandId) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        javax.persistence.Query query = emanager.createNamedQuery("Item.findByBrandId");
        query.setParameter("brandId", brandId);
        java.util.List<com.app.shared.shoppingcontext.onlineshopping.Item> listOfItem = query.getResultList();
        Log.out.println("nullOS324100200", runtimeLogInfoHelper.getRequestHeaderBean(), "ItemRepositoryImpl", "findByBrandId", "Total Records Fetched = " + listOfItem.size());
        return listOfItem;
    }
    ...
    public Item findById(String itemId) throws Exception {
        ...
        Log.out.println("nullOS324100200", runtimeLogInfoHelper.getRequestHeaderBean(), "ItemRepositoryImpl", "findById", "Total Records Fetched = " + listOfItem);
        return listOfItem;
    }
}
