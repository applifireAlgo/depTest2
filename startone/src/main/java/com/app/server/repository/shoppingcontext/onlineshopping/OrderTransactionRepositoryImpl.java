...
@Repository
@SourceCodeAuthorClass(createdBy = "deepali.arvind@algorhythm.co.in", updatedBy = "deepali.arvind@algorhythm.co.in", versionNumber = "2", comments = "Repository for OrderTransaction Master table Entity", complexity = Complexity.LOW)
public class OrderTransactionRepositoryImpl extends SearchInterfaceImpl implements OrderTransactionRepository<OrderTransaction> {
    ...
    @Override
    @Transactional
    public List<OrderTransaction> findAll() throws Exception {
        ...
        Log.out.println("nullOS324100200", runtimeLogInfoHelper.getRequestHeaderBean(), "OrderTransactionRepositoryImpl", "findAll", "Total Records Fetched = " + query.size());
        return query;
    }

    @Override
    @Transactional
    public OrderTransaction save(OrderTransaction entity) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        emanager.persist(entity);
        Log.out.println("nullOS322100200", runtimeLogInfoHelper.getRequestHeaderBean(), "OrderTransactionRepositoryImpl", "save", entity);
        return entity;
    }

    @Override
    @Transactional
    public List<OrderTransaction> save(List<OrderTransaction> entity) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        for (int i = 0; i < entity.size(); i++) {
            com.app.shared.shoppingcontext.onlineshopping.OrderTransaction obj = entity.get(i);
            emanager.persist(obj);
        }
        Log.out.println("nullOS322100200", runtimeLogInfoHelper.getRequestHeaderBean(), "OrderTransactionRepositoryImpl", "saveAll", "Total Records saved = " + entity.size());
        return entity;
    }
    ...
    public void delete(String id) throws Exception {
        ...
        emanager.remove(s);
        Log.out.println("nullOS328100200", runtimeLogInfoHelper.getRequestHeaderBean(), "OrderTransactionRepositoryImpl", "delete", "Record Deleted");
    }

    @Override
    @Transactional
    public void update(OrderTransaction entity) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        emanager.merge(entity);
        Log.out.println("nullOS321100200", runtimeLogInfoHelper.getRequestHeaderBean(), "OrderTransactionRepositoryImpl", "update", entity);
    }

    @Override
    @Transactional
    public void update(List<OrderTransaction> entity) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        for (int i = 0; i < entity.size(); i++) {
            com.app.shared.shoppingcontext.onlineshopping.OrderTransaction obj = entity.get(i);
            emanager.merge(obj);
        }
        Log.out.println("nullOS321100200", runtimeLogInfoHelper.getRequestHeaderBean(), "OrderTransactionRepositoryImpl", "updateAll", "Total Records updated = " + entity.size());
    }
    ...
    public List<Object> search(String finderName, Map<String, Object> fields, Map<String, String> fieldMetaData) throws Exception {
        ...
        Log.out.println("nullOS324100200", runtimeLogInfoHelper.getRequestHeaderBean(), "OrderTransactionRepositoryImpl", "search", "Total Records Fetched = " + list.size());
        return list;
    }

    @Transactional
    public List<OrderTransaction> findByOrderId(String orderId) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        ...
        Log.out.println("nullOS324100200", runtimeLogInfoHelper.getRequestHeaderBean(), "OrderTransactionRepositoryImpl", "findByOrderId", "Total Records Fetched = " + listOfOrderTransaction.size());
        return listOfOrderTransaction;
    }

    @Transactional
    public OrderTransaction findById(String orderTransactionId) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        ...
        Log.out.println("nullOS324100200", runtimeLogInfoHelper.getRequestHeaderBean(), "OrderTransactionRepositoryImpl", "findById", "Total Records Fetched = " + listOfOrderTransaction);
        return listOfOrderTransaction;
    }
}
