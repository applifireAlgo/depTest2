...
@Repository
@SourceCodeAuthorClass(createdBy = "deepali.arvind@algorhythm.co.in", updatedBy = "deepali.arvind@algorhythm.co.in", versionNumber = "2", comments = "Repository for Taluka Master table Entity", complexity = Complexity.LOW)
public class TalukaRepositoryImpl extends SearchInterfaceImpl implements TalukaRepository<Taluka> {
    ...
    public List<Taluka> findAll() throws Exception {
        ...
        java.util.List<com.app.shared.organization.locationmanagement.Taluka> query = emanager.createQuery("select u from Taluka u where u.systemInfo.activeStatus=1").getResultList();
        Log.out.println("nullLM324100200", runtimeLogInfoHelper.getRequestHeaderBean(), "TalukaRepositoryImpl", "findAll", "Total Records Fetched = " + query.size());
        return query;
    }
    ...
    public Taluka save(Taluka entity) throws Exception {
        ...
        Log.out.println("nullLM322100200", runtimeLogInfoHelper.getRequestHeaderBean(), "TalukaRepositoryImpl", "save", entity);
        return entity;
    }
    ...
    public List<Taluka> save(List<Taluka> entity) throws Exception {
        ...
        for (int i = 0; i < entity.size(); i++) {
            com.app.shared.organization.locationmanagement.Taluka obj = entity.get(i);
            emanager.persist(obj);
        }
        Log.out.println("nullLM322100200", runtimeLogInfoHelper.getRequestHeaderBean(), "TalukaRepositoryImpl", "saveAll", "Total Records saved = " + entity.size());
        return entity;
    }
    ...
    public void delete(String id) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        com.app.shared.organization.locationmanagement.Taluka s = emanager.find(com.app.shared.organization.locationmanagement.Taluka.class, id);
        emanager.remove(s);
        Log.out.println("nullLM328100200", runtimeLogInfoHelper.getRequestHeaderBean(), "TalukaRepositoryImpl", "delete", "Record Deleted");
    }
    ...
    public void update(Taluka entity) throws Exception {
        ...
        Log.out.println("nullLM321100200", runtimeLogInfoHelper.getRequestHeaderBean(), "TalukaRepositoryImpl", "update", entity);
    }
    ...
    public void update(List<Taluka> entity) throws Exception {
        ...
        Log.out.println("nullLM321100200", runtimeLogInfoHelper.getRequestHeaderBean(), "TalukaRepositoryImpl", "updateAll", "Total Records updated = " + entity.size());
    }
    ...
    public List<Object> search(String finderName, Map<String, Object> fields, Map<String, String> fieldMetaData) throws Exception {
        ...
        Log.out.println("nullLM324100200", runtimeLogInfoHelper.getRequestHeaderBean(), "TalukaRepositoryImpl", "search", "Total Records Fetched = " + list.size());
        return list;
    }
    ...
    public List<Taluka> findByCountryId(String countryId) throws Exception {
        ...
        java.util.List<com.app.shared.organization.locationmanagement.Taluka> listOfTaluka = query.getResultList();
        Log.out.println("nullLM324100200", runtimeLogInfoHelper.getRequestHeaderBean(), "TalukaRepositoryImpl", "findByCountryId", "Total Records Fetched = " + listOfTaluka.size());
        return listOfTaluka;
    }
    ...
    public List<Taluka> findByStateId(String stateId) throws Exception {
        ...
        java.util.List<com.app.shared.organization.locationmanagement.Taluka> listOfTaluka = query.getResultList();
        Log.out.println("nullLM324100200", runtimeLogInfoHelper.getRequestHeaderBean(), "TalukaRepositoryImpl", "findByStateId", "Total Records Fetched = " + listOfTaluka.size());
        return listOfTaluka;
    }
    ...
    public List<Taluka> findByRegionId(String regionId) throws Exception {
        ...
        java.util.List<com.app.shared.organization.locationmanagement.Taluka> listOfTaluka = query.getResultList();
        Log.out.println("nullLM324100200", runtimeLogInfoHelper.getRequestHeaderBean(), "TalukaRepositoryImpl", "findByRegionId", "Total Records Fetched = " + listOfTaluka.size());
        return listOfTaluka;
    }
    ...
    public List<Taluka> findByDistrictId(String districtId) throws Exception {
        ...
        java.util.List<com.app.shared.organization.locationmanagement.Taluka> listOfTaluka = query.getResultList();
        Log.out.println("nullLM324100200", runtimeLogInfoHelper.getRequestHeaderBean(), "TalukaRepositoryImpl", "findByDistrictId", "Total Records Fetched = " + listOfTaluka.size());
        return listOfTaluka;
    }
    ...
    public Taluka findById(String talukaId) throws Exception {
        ...
        com.app.shared.organization.locationmanagement.Taluka listOfTaluka = (com.app.shared.organization.locationmanagement.Taluka) query.getSingleResult();
        Log.out.println("nullLM324100200", runtimeLogInfoHelper.getRequestHeaderBean(), "TalukaRepositoryImpl", "findById", "Total Records Fetched = " + listOfTaluka);
        return listOfTaluka;
    }
}
