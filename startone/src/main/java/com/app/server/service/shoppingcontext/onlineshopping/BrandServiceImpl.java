...
public class BrandServiceImpl extends BrandService {
    ...
    public HttpEntity<ResponseBean> search(@RequestBody Map<String, Object> fieldData) throws Exception {
        ...
        responseBean.add("message", String.format(appAlarm.getMessage(), "Brand"));
        responseBean.add("data", lstbrand);
        Log.out.println(appAlarm.getAlarmID(), runtimeLogInfoHelper.getRequestHeaderBean(), "BrandServiceImpl", "search", "Brand");
        return new org.springframework.http.ResponseEntity<ResponseBean>(responseBean, HttpStatus.valueOf(appAlarm.getAlarmStatus()));
    }
    ...
    public HttpEntity<ResponseBean> findByProductId(@RequestBody FindByBean findByBean) throws Exception {
        ...
        responseBean.add("message", String.format(appAlarm.getMessage(), "Brand"));
        responseBean.add("data", lstbrand);
        Log.out.println("nullOS124100200", runtimeLogInfoHelper.getRequestHeaderBean(), "BrandServiceImpl", "save", "Brand");
        return new org.springframework.http.ResponseEntity<ResponseBean>(responseBean, HttpStatus.valueOf(appAlarm.getAlarmStatus()));
    }
