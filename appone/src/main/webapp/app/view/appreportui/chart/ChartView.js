Ext.define('Appone.view.appreportui.chart.ChartView', {
	extend : 'Ext.panel.Panel',
	requires:['Appone.view.appreportui.chart.ChartViewController',
	          'Appone.view.appreportui.chart.ChartPanel',
	          'Appone.view.appreportui.chart.GroupChartPanel'],
