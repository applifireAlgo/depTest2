...
Ext
		.define(
				'Appone.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Appone.view.logger.tabs.details.DetailsTab',
							'Appone.view.logger.tabs.fileconnector.FileConnectorTab',
							'Appone.view.logger.tabs.dbconnector.DBConnectorTab',
							'Appone.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Appone.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Appone.view.logger.LogConfigurationTabPanelController',
