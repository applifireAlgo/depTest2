 ...
 * 
 */
Ext.define('Appone.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Appone.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
