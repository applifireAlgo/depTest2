Ext.define('Appone.view.usermanagement.enduser.UserProfile', {
	extend : 'Ext.form.Panel',
	xtype : 'userProfileView',
	requires : [ 'Appone.view.usermanagement.enduser.UserProfileController', 'Appone.view.usermanagement.admin.AddUserDetailsViewModel', 'Appone.model.AddUserDataModel' ],
