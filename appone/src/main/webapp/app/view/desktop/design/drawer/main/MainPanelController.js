Ext.define('Appone.view.desktop.design.drawer.main.MainPanelController', {
    ...
    onMyProfileClick : function()
    {
         ...
         this.pushViewInMainTab( "Appone.view.usermanagement.enduser.UserProfile","My Profile","menuAction","Appone.view.usermanagement.enduser.UserProfile");
    },
    
    onChangePwdClick:function()
    {
      
         this.pushViewInMainTab( "Appone.view.usermanagement.enduser.ChangePwd","Change Password","menuAction","Appone.view.usermanagement.enduser.ChangePwd");
    },
     onCloudClick : function()
    {
        
        this.pushViewInMainTab("Appone.view.clouddrive.CloudDrive","Cloud Drive","menuAction","Appone.view.clouddrive.CloudDrive");
    },
