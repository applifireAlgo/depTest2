Ext.define('Appone.view.fw.frameworkController.RegistrationGridViewController', {
     extend: 'Appone.view.fw.frameworkController.FrameworkViewController',
     ...
     onConsoleClick: function() {
          var window = Ext.create('Appone.view.console.ConsoleWindow');
