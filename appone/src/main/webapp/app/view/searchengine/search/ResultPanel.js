Ext
		.define(
				'Appone.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Appone.view.searchengine.search.SearchEngineMainPanelController','Appone.view.searchengine.search.PanelHeaderField' ,'Appone.view.searchengine.search.ReportGridView','Appone.view.searchengine.search.ReportChartView','Appone.view.searchengine.search.documentView','Appone.view.searchengine.search.DouMeanView','Appone.view.googlemaps.map.MapPanel'],
