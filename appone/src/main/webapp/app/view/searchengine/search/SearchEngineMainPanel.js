Ext.define('Appone.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'solrsearchmainpanel',
	

	requires : ['Appone.view.searchengine.search.NorthPanel', 'Appone.view.searchengine.search.SearchResult','Appone.view.searchengine.search.SearchEngineMainPanelController'],
