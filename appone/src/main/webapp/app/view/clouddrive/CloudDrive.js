Ext.define("Appone.view.clouddrive.CloudDrive", {
	extend : 'Ext.panel.Panel',
	xtype : 'clouddrive',
	requires : [ 'Appone.view.clouddrive.CloudDriveController',
	             'Appone.view.clouddrive.documentview.DocumentsView',
	             'Appone.view.clouddrive.drivedetails.DriveDetails',
	             //'Appone.view.clouddrive.documentview.DocumentListView'
	             ],
