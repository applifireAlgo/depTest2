 ...
 * 
 */
Ext.define('Appone.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Appone.view.logalarm.LogAlarmMainViewController',
			'Appone.view.logalarm.tree.LogAlarmTreePanel',
			'Appone.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
