 ...
 * 
 */
Ext.define('Appone.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Appone.view.logalarm.mainscreen.AddLogAlarmController',
			'Appone.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Appone.view.logalarm.mainscreen.AppAlarmPanel',
